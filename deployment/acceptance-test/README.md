...
- Ir a los archivos .feature (src>test>resources>co.com.technicaltestbamcolombia) agregar tus escenarios, métodos de prueba, aserciones, y todo lo necesario para tus pruebas en particular.
...
??? test
    ??? java
    ?   ??? co.com.technicaltestbamcolombia
    ?       ??? TestParallel.java
    ?       ??? utils
